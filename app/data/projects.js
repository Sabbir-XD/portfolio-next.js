export const projects = [
  {
    id: 1,
    title: "🐾 PawAdopt - Pet Adoption & Donation Platform",
    image: "https://i.ibb.co/9HcnkBJh/pet.png",
    technologies: [
      "React.js (Vite)",
      "Node.js",
      "Express.js",
    ...
    description:
      "PawAdopt is a full-featured pet adoption and donation platform connecting pets with loving families. It allows users to browse and adopt pets, start donation campaigns, manage listings, and provides a powerful admin panel for full system control.",
    liveLink: "https://pawadopt-pet.web.app/",
    githubLink: "https://github.com/Sabbir-XD/pawadopt",
    challenges: [
      "Implementing secure Stripe payment integration for donations.",
      "Managing role-based dashboards for pet seekers, pet owners, and admins.",
      "Handling media uploads and storage with Cloudinary.",
      "Synchronizing adoption requests and approval workflow between multiple roles.",
    ],
    improvements: [
      "Add real-time chat between pet seekers and owners.",
      "Implement advanced search and filters for pets by breed, age, and location.",
      "Introduce mobile app version for broader accessibility.",
      "Add donation analytics and reporting for admins.",
      "Enhance adoption tracking with notifications and status updates.",
    ],
  },
  {
    id: 2,
